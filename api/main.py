...
from api.routes import dashboard, trades, positions, strategies, daily_reports, bot_control, charts, scanner
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8282", "http://127.0.0.1:8282", "http://localhost:3000"],
